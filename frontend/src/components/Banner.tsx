  ...
  return (
    <section className="relative h-svh">
      ...
      <div className="absolute z-10 mt-20 flex w-full flex-col justify-center p-10 text-white md:p-16">
        <p
          className={`text-2xl font-medium md:text-3xl lg:text-4xl ${isText1Animated ? "animate-fadeInUp" : "collapse"}`}
        >
          건설 분쟁 컨설팅 전문
        </p>
        <div className="h-6 md:h-7 lg:h-8"></div>
        <p
          className={`text-[38px] font-medium md:text-[50px] lg:text-[70px] ${isText2Animated ? "animate-fadeInUp" : "collapse"}`}
        >
